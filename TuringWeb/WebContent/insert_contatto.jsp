<%@page import="main.java.it.beije.turing.web.Contatto"%>
...
<jsp:useBean id="contatto" class="main.java.it.beije.turing.web.Contatto"></jsp:useBean>
<%--
...
<%
    System.out.println("entro nella jsp");
