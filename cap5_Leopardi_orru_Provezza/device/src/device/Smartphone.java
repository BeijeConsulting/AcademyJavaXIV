...
public class Smartphone extends Utility implements TouchScreen, Video, Microphone, Audio, Camera{
	...
	public void displayInfo(String s) {
		System.out.println("On the smartphone screen, you can read: "+s+".");
	...
	public void playVideo(String s) {
		System.out.println("Your are watching "+s+" on this smartphone.");
		
	}

	@Override
	public void hasTouchscreen() {
		System.out.println("This smarphone has a OLED touchscreen");
		
	}

	@Override
	public void useCase(String s) {
		System.out.println("You are using this smartphone to: "+s+".");
